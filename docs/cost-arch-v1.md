...
This document estimates the monthly cost of running the PPCRV serverless architecture described in [README.md](readme-arch-v1.md). The architecture is compared against the initial EC2-based proposal (`~$714/month` always-on).
